...
from adv_function.idc_utils import save_quantization, load_quantization, save_totalR, load_totalR
from adv_function.idc_utils import save_layerwise_relevances, load_layerwise_relevances
from adv_function.idc_utils import get_layer_outs_new
from adv_function.model_io import write, read
...
class ImportanceDrivenCoverage:
    def __init__(self, model, dataset, model_name, num_relevant_neurons, selected_class, subject_layer,
    ...
    def test(self, test_inputs):
        ...
        lrpmodel = read('/home/zhiyu/temp/leNet_1' + '.txt', 'txt')  # 99.16% prediction accuracy
